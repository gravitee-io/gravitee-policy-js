...
* enable MCP, LLM and A2A proxy API types ([01d08eb](https://github.com/gravitee-io/gravitee-policy-js/commit/01d08ebccfe9d5370e24314462309a91056ec348))
...
* update schema-form.json to use monacoEditorConfig for code editor settings ([44b6444](https://github.com/gravitee-io/gravitee-policy-js/commit/44b644481007a7dff17d22f81a8228f3f44c7c93))
